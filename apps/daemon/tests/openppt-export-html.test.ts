...
`;
    ...
    expect(firstStyle).toContain('data-openppt-vault-tokens');
    expect(head).not.toContain('html, body { overflow: hidden; width: 800px; height: 500px;');
    expect(head).not.toContain('*, *::before, *::after');
