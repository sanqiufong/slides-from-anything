...
export interface Dict {
  ...
  'designs.sortAria': string;
  'designs.sort.createdDesc': string;
  'designs.sort.createdAsc': string;
  'designs.sort.updatedDesc': string;
  'designs.sort.nameAsc': string;
  'designs.sort.nameDesc': string;
  'designs.sort.status': string;
  'designs.searchPlaceholder': string;
  'vault.sort.aria': string;
  'vault.sort.quality': string;
  'vault.sort.updated': string;
  'vault.sort.created': string;
  'vault.sort.title': string;
  'vault.sort.source': string;
  'vault.sort.category': string;
  'vault.sort.asc': string;
  'vault.sort.desc': string;
  'vault.filter.all': string;
  'vault.filter.source': string;
  'vault.filter.category': string;
  'vault.filter.marker': string;
  'vault.filter.tags': string;
  'vault.filter.favorites': string;
  ...
  'chat.expandPane': string;
  'chat.agentRunning': string;
  ...
  'chat.vaultContextPickerTitle': string;
  'chat.vaultContextPickerDesc': string;
  'chat.vaultContextSearch': string;
  'chat.vaultContextLoading': string;
  'chat.vaultContextEmpty': string;
  'chat.vaultContextSelected': string;
  'chat.vaultContextSkill': string;
  'chat.vaultContextDesignSystem': string;
  'chat.vaultContextComponentSystem': string;
  'chat.vaultContextPresentationSystem': string;
  'chat.vaultContextNoSummary': string;
  'chat.vaultContextRemove': string;
  'chat.vaultContextRemoveAria': string;
  'chat.vaultContextFilterAll': string;
  'chat.vaultContextFilterKind': string;
  'chat.vaultContextFilterSource': string;
  'chat.vaultContextFilterTag': string;
  'chat.vaultContextFilterQuality': string;
  'chat.vaultContextFilterQualityHint': string;
  'chat.vaultContextSortQuality': string;
  'chat.vaultContextSortRecent': string;
  'chat.vaultContextSortTitle': string;
  'chat.vaultContextSourceUrl': string;
  'chat.vaultContextSourceClone': string;
  'chat.vaultContextSourceProject': string;
  'chat.vaultContextNoMatch': string;
  'chat.vaultContextResultCount': string;
  'chat.vaultContextSelect': string;
  'chat.vaultContextSelectAlready': string;
  'chat.vaultContextPreviewHint': string;
  'chat.vaultContextEmptySelection': string;
  'chat.vaultContextClearFilters': string;
  'chat.send': string;
  'chat.stop': string;
  ...
  'openPpt.coreArtifact': string;
  'openPpt.webPptDeck': string;
  ...
  'openSlide.view': string;
  'openSlide.slides': string;
  'openSlide.assets': string;
  'openSlide.pages': string;
  'openSlide.slideAssets': string;
  'openSlide.assetsEmpty': string;
  'openSlide.design': string;
  'openSlide.inspect': string;
  'openSlide.export': string;
  'openSlide.exportMenu': string;
  'openSlide.exporting': string;
  'openSlide.exportHtmlPdfAssets': string;
  'openSlide.exportPptxEditable': string;
  'openSlide.exportPptxRaster': string;
  'openSlide.exportFailed': string;
  'openSlide.present': string;
  'openSlide.undo': string;
  'openSlide.redo': string;
  'openSlide.redoAvailable': string;
  'openSlide.renderFailed': string;
  'openSlide.typeScriptDiagnostics': string;
  'openSlide.loadingSource': string;
  'openSlide.unsavedZero': string;
  'openSlide.unsavedOne': string;
  'openSlide.unsavedMany': string;
  'openSlide.selectElement': string;
  'openSlide.ready': string;
  'openSlide.discard': string;
  'openSlide.saving': string;
  'openSlide.feedback.add': string;
  'openSlide.feedback.close': string;
  'openSlide.feedback.placeholder': string;
  'openSlide.feedback.queue': string;
  'openSlide.feedback.triggerAgent': string;
  'openSlide.queuedOne': string;
  'openSlide.queuedMany': string;
  'openSlide.comments.close': string;
  'openSlide.comments.empty': string;
  'openSlide.pageLine': string;
  'openSlide.applyQueued': string;
  'openSlide.inspector': string;
  'openSlide.inspector.close': string;
  'openSlide.inspectorMode': string;
  'openSlide.properties': string;
  'openSlide.move': string;
  'openSlide.feedback': string;
  'openSlide.selection': string;
  'openSlide.selectionHint': string;
  'openSlide.moveReady': string;
  'openSlide.moveDisabledNoSelection': string;
  'openSlide.moveDisabledRepeated': string;
  'openSlide.moveDisabledInline': string;
  'openSlide.moveDisabledStructural': string;
  'openSlide.moveDisabledTable': string;
  'openSlide.moveDisabledVisual': string;
  'openSlide.feedbackModeReady': string;
  'openSlide.content': string;
  'openSlide.layout': string;
  'openSlide.positionSize': string;
  'openSlide.positionX': string;
  'openSlide.positionY': string;
  'openSlide.width': string;
  'openSlide.height': string;
  'openSlide.opacity': string;
  'openSlide.radius': string;
  'openSlide.typography': string;
  'openSlide.size': string;
  'openSlide.weight': string;
  'openSlide.weightLight': string;
  'openSlide.weightRegular': string;
  'openSlide.weightMedium': string;
  'openSlide.weightSemibold': string;
  'openSlide.weightBold': string;
  'openSlide.weightExtra': string;
  'openSlide.style': string;
  'openSlide.bold': string;
  'openSlide.italic': string;
  'openSlide.lineHeight': string;
  'openSlide.tracking': string;
  'openSlide.align': string;
  'openSlide.alignLeft': string;
  'openSlide.alignCenter': string;
  'openSlide.alignRight': string;
  'openSlide.alignJustify': string;
  'openSlide.color': string;
  'openSlide.text': string;
  'openSlide.background': string;
  'openSlide.source': string;
  'openSlide.designTokens': string;
  'openSlide.design.close': string;
  'openSlide.colors': string;
  'openSlide.accent': string;
  'openSlide.display': string;
  'openSlide.body': string;
  'openSlide.hero': string;
  'openSlide.shape': string;
  'openSlide.unitPx': string;
  'openSlide.clearField': string;
  'openSlide.locked': string;
  'openSlide.lockedInlineLayout': string;
  'openSlide.lockedTableLayout': string;
  'openSlide.lockedNonText': string;
  'openSlide.lockedStructural': string;
  'openSlide.player.aria': string;
  'openSlide.player.previous': string;
  'openSlide.player.next': string;
  'openSlide.player.overview': string;
  'openSlide.player.blackout': string;
  'openSlide.player.whiteout': string;
  'openSlide.player.laser': string;
  'openSlide.player.help': string;
  'openSlide.player.exit': string;
  'openSlide.player.helpTitle': string;
  'openSlide.player.helpBody': string;
  'openSlide.player.gotIt': string;
  ...
  'qf.vaultTemplateTitle': string;
  'qf.vaultTemplateLabel': string;
  'qf.vaultBrowseAll': string;
  'qf.vaultBrowseAllDesc': string;
  'qf.vaultBrowseAllCount': string;
  'qf.vaultBrowseInstall': string;
  'qf.vaultBrowseInstallDesc': string;
  'qf.vaultPickerTitle': string;
  'qf.vaultPickerDesc': string;
  'qf.vaultPickerReadOnlyDesc': string;
  'qf.vaultSearchPlaceholder': string;
  'qf.vaultNoTemplates': string;
  'qf.vaultNoMatch': string;
  'qf.vaultInstallTitle': string;
  'qf.vaultInstallBody': string;
  'qf.vaultInstallAction': string;
  'qf.vaultInstallRefresh': string;
  'qf.vaultInstallRefreshing': string;
  'qf.vaultInstallRefreshDone': string;
  'qf.vaultAgentChoose': string;
  'qf.vaultAgentChooseDesc': string;
  'qf.vaultPalette': string;
  'qf.vaultLayout': string;
  'qf.vaultFont': string;
