...
export const FR_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'open-design-landing': {
    examplePrompt:
      'Concevez la landing page marketing Slides from Anything dans le style Atelier Zero / Monocle — canvas papier chaud, collage surréaliste plâtre + architecture, grande typographie display serif italique mixée, chiffres romains comme marqueurs de sections et un seul accent corail.',
  },
  'open-design-landing-deck': {
    examplePrompt:
      'Créez le pitch deck Slides from Anything dans le style Atelier Zero — cover avec hero plate, séparateurs de section en chiffres romains, slide stats (31 Skills · 72 systèmes · 12 CLIs), citation client, CTA et end-card mega italic-serif. Pagination horizontal-swipe comme un magazine imprimé.',
    description:
  ...
  'openppt-deck': {
    examplePrompt:
      'Créez un deck SFA Web-PPT éditable sur notre nouvelle stratégie d’opérations IA — avec template Design Vault, canvas Open Slide, motion sobre et export PPTX optionnel.',
    description:
      'Crée et révise des decks SFA Web-PPT éditables. La source canonique reste Open Slide TSX ; contexte Design Vault, feedback par slide, motion helpers et export PPTX vivent dans le même workflow.',
  },
  'pm-spec': {
    examplePrompt:
