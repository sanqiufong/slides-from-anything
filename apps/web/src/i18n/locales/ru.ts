...
export const ru: Dict = {
  ...
  'chat.collapsePane': 'Свернуть разговор',
  'chat.expandPane': 'Развернуть разговор',
  'chat.agentRunning': 'Агент выполняется',
  ...
  'chat.notice.deckMediaNoProvider':
    'Провайдер генерации изображений пока не настроен. Я продолжу создавать презентацию и явно отмечу медиаслоты, чтобы вы могли позже настроить модель и сгенерировать эти изображения.',
  'chat.notice.deckMediaAmbiguousProvider':
    'Доступно несколько провайдеров генерации изображений ({choices}). Я продолжу с медиаслотами в ожидании, пока вы не укажете, какую модель использовать.',
  'chat.error.deckMediaConfigWriteFailed':
    'Не удалось сохранить настройки медиа для презентации, поэтому отправка остановлена, чтобы не потерять план запрошенных слотов изображений.',
