...
export const fa: Dict = {
  ...
  'chat.collapsePane': 'جمع کردن مکالمه',
  'chat.expandPane': 'باز کردن مکالمه',
  'chat.agentRunning': 'عامل در حال اجراست',
  ...
  'chat.notice.deckMediaNoProvider':
    'هنوز هیچ ارائه‌دهنده تولید تصویر پیکربندی نشده است. ساخت ارائه را با جایگاه‌های رسانه‌ای مشخص ادامه می‌دهم تا بعدا بتوانید یک مدل تنظیم کنید و این تصاویر را بسازید.',
  'chat.notice.deckMediaAmbiguousProvider':
    'چند ارائه‌دهنده تولید تصویر در دسترس است ({choices}). تا زمانی که مشخص کنید از کدام مدل استفاده شود، با جایگاه‌های رسانه‌ای در انتظار ادامه می‌دهم.',
  'chat.error.deckMediaConfigWriteFailed':
    'تنظیمات رسانه‌ای ارائه ذخیره نشد، بنابراین ارسال متوقف شد تا طرح جایگاه‌های تصویر درخواستی از دست نرود.',
