...
export const uk: Dict = {
  ...
  'chat.collapsePane': 'Згорнути розмову',
  'chat.expandPane': 'Розгорнути розмову',
  'chat.agentRunning': 'Агент виконується',
  ...
  'chat.notice.deckMediaNoProvider':
    'Провайдера генерації зображень ще не налаштовано. Я продовжу створення презентації та чітко позначу медіаслоти, щоб ви могли пізніше налаштувати модель і згенерувати ці зображення.',
  'chat.notice.deckMediaAmbiguousProvider':
    'Доступно кілька провайдерів генерації зображень ({choices}). Я продовжу з медіаслотами в очікуванні, доки ви не вкажете, яку модель використовувати.',
  'chat.error.deckMediaConfigWriteFailed':
    'Не вдалося зберегти медіаналаштування презентації, тому надсилання зупинено, щоб не втратити план потрібних слотів зображень.',
