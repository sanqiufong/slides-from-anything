...
export const zhTW: Dict = {
  ...
  'designs.sortAria': '排序專案',
  'designs.sort.createdDesc': '最近建立',
  'designs.sort.createdAsc': '最早建立',
  'designs.sort.updatedDesc': '最近更新',
  'designs.sort.nameAsc': '名稱 A-Z',
  'designs.sort.nameDesc': '名稱 Z-A',
  'designs.sort.status': '狀態',
  'designs.searchPlaceholder': '搜尋…',
  'vault.sort.aria': '排序模板',
  'vault.sort.quality': '品質優先',
  'vault.sort.updated': '最近更新',
  'vault.sort.created': '最新建立',
  'vault.sort.title': '標題',
  'vault.sort.source': '來源',
  'vault.sort.category': '分類',
  'vault.sort.asc': '升冪',
  'vault.sort.desc': '降冪',
  'vault.filter.all': '全部',
  'vault.filter.source': '來源',
  'vault.filter.category': '分類',
  'vault.filter.marker': '標記',
  'vault.filter.tags': '標籤',
  ...
  'chat.collapsePane': '收起會話',
  'chat.expandPane': '展開會話',
  'chat.agentRunning': 'Agent 正在執行',
  ...
  'chat.notice.deckMediaNoProvider':
    '目前還沒有可用的圖片生成環境。生成會繼續，並在 PPT 中保留明確的待生成配圖位置；你後續設定圖片模型後再補生成即可。',
  'chat.notice.deckMediaAmbiguousProvider':
    '目前有多個圖片生成環境（{choices}）。生成會先繼續，並在 PPT 中保留待生成配圖位置；你後續指定模型後再補生成即可。',
  'chat.error.deckMediaConfigWriteFailed':
    '無法寫入 deckMedia 專案設定；已停止傳送，避免遺失本輪要求的配圖佔位規劃。',
  ...
  'openSlide.design': '主題',
  'openSlide.inspect': '微調',
  'openSlide.export': '匯出',
  'openSlide.exportMenu': '匯出演示文稿',
  'openSlide.exporting': '匯出中...',
  'openSlide.exportHtmlPdfAssets': 'HTML/PDF 素材包',
  'openSlide.exportPptxEditable': 'PPTX',
  'openSlide.exportPptxRaster': 'PPTX（點陣）',
  'openSlide.exportFailed': '匯出失敗：{message}',
  'openSlide.selectElement': '選擇元素進行微調',
  'openSlide.comments.empty': '還沒有暫存批註。用「微調」選擇元素並描述修改意見。',
  'openSlide.inspector': '微調面板',
  'openSlide.inspector.close': '關閉微調面板',
  'openSlide.inspectorMode': '微調模式',
  'openSlide.designTokens': '主題 token',
  'openSlide.design.close': '關閉主題面板',
  ...
  'qf.vaultTemplateTitle': '選擇設計風格參考模板',
  'qf.vaultTemplateLabel': '設計風格參考模板',
  'qf.vaultBrowseInstall': '去 Design Vault 挑選安裝',
  'qf.vaultBrowseInstallDesc': '安裝後回到這裡重新整理拉取。',
  'qf.vaultInstallTitle': '目前還沒有本地 Vault 模板',
  'qf.vaultInstallBody': '可以先去 Design Vault 挑選並安裝模板。回來後點擊重新整理拉取，就會出現在這裡。',
  'qf.vaultInstallAction': '開啟 Design Vault',
  'qf.vaultInstallRefresh': '重新整理拉取',
  'qf.vaultInstallRefreshing': '拉取中...',
  'qf.vaultInstallRefreshDone': '已重新整理，目前可用 {count} 個模板。',
