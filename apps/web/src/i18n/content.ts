...
const DE_SKILL_COPY: Record<string, LocalizedSkillCopy> = {
  ...
  'openppt-deck': {
    examplePrompt:
      'Erstellen Sie ein editierbares SFA Web-PPT-Deck über unsere neue KI-Operations-Strategie — mit Design-Vault-Vorlage, Open-Slide-Canvas, restrained Motion und optionalem PPTX-Export.',
    description:
      'Erstellt und überarbeitet editierbare SFA Web-PPT-Decks. Open Slide TSX bleibt die kanonische Quelle; Design-Vault-Kontext, Slide-Feedback, Motion-Helper und PPTX-Export werden in denselben Workflow eingebunden.',
  },
  'pm-spec': {
    examplePrompt:
