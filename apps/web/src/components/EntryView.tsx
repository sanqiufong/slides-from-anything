...
import { VaultTemplatesTab } from './VaultTemplatesTab';
      ...
      <aside className="entry-side" style={{ width: sidebarWidth }}>
        <div className="entry-brand">
          <span className="entry-brand-mark" aria-hidden>
            <img src="/brand-logo.png" alt="" className="brand-mark-img" draggable={false} />
          </span>
      ...
      <main className="entry-main">
        <div className="entry-header">
          <div className="entry-tabs" role="tablist">
            <TopTabButton current={topTab} value="designs" label="SFA Projects" onClick={setTopTab} />
            <TopTabButton
              current={topTab}
        ...
        <div className="entry-tab-content">
          {loading ? (
            ...
            <>
              {topTab === 'designs' ? (
                <DesignsTab
                  projects={projects.filter((project) => project.metadata?.kind === 'deck')}
                  skills={skills}
                  designSystems={designSystems}
