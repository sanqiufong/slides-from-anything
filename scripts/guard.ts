...
const residualAllowedExactPaths = new Set([
  ...
  // Framework compatibility config files copied with the Design Vault Next app.
  "apps/design-vault/apps/community/eslint.config.mjs",
  "apps/design-vault/eslint.config.mjs",
  "apps/design-vault/postcss.config.mjs",
...
const residualAllowedPathPrefixes = [
  ...
  // Embedded Design Vault snapshots can include upstream vendor runtime assets.
  "design-vault/data/designs/",
  // Materialized Design Vault skills preserve upstream assets/scripts under dv-*.
  "skills/dv-",
  "test-results/",
  "vendor/",
];
